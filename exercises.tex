...
\exercise{Let $a = 101$. If $a$ is squared in GF($2^3$) with irreducible polynomial $p(x) = x^3 + x + 1$ (1011 in binary), the product $d = a \times a =$ ?~\cite[p51]{Denning1982}}{111}
...
What is the probability that the other ball is white?~\cite[Ex~II.1, p2.12]{King2007}}{$\frac{2}{3}$}
\exercise{One person in 1000 is know to suffer from Nerd's Syndrome (a pathological inability to resist playing computer games).
...
What is the probability that this person actually suffers from Nerd's Syndrome?~\cite[Ex~II.3, p2.13]{King2007}}{$\frac{11}{233}$}
...
What is the probability that \emph{no} participant goes home with his original card?~\cite[Ex~II.8, p2.14]{King2007}}{$\frac{3}{8}$}
...
\exercise{Show how to determine that an $n$-bit string is in $\Z_N^*$\cite[p515, B.4]{Katz2008}}{Solutions welcome.}
